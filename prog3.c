 ...
 * @file prog3.c
 * @brief 网络仿真主体代码
 * @details 运行网络仿真的程序, main函数中调用了node文件中的函数
 */
#include <stdio.h>
#include <stdlib.h>
 ...
 * - 1: 使用我自己实现的版本
 *
 * @note JIMSRAND原来的版本在我的机器上无法正常产生[0, 1]的随机数,
 *  JIMSRAND_VERSION应设置为1
 */
#define JIMSRAND_VERSION 1
/* ******************************************************************
